...
\includegraphics[width=0.9\textwidth]{base_metal_annotated}
  ...
  \label{fig:sfig2}
\end{subfigure}
\caption{(a) Base layout of transistors with active regions, poly, etc. (b) The same layout with only metal connection layers shown. Annotated with locations of transistors.}
